...
const allItemsURL = 'http://localhost:8080/luma/api/all_items';
const applyLoanUrl = 'http://localhost:8080/luma/api/applyforloan';
const categoryURL = 'http://localhost:8080/luma/api/item_category';
const itemMakeURL = 'http://localhost:8080/luma/api/item_make';
...
function ApplyLoan() {
  ...
  //diplaying item category  from db
    useEffect(() => {
    ...
    //displays the item make under the category
    useEffect(() => {
